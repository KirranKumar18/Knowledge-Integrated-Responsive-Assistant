...
- Termux client capturing voice and playing response
- Basic back and forth working
...
### Phase 5 — Fine Tuning
- Collect personal usage data from phases 1-4
- Fine-tune phi3:mini using LoRA on Google Colab
- Replace base model with fine-tuned version

### Phase 6 — Polish
- Custom voice profile
- LED or visual feedback
...
- Do NOT use OpenAI API anywhere — Gemini is the only external AI allowed
- Always ask user permission before calling Gemini
- phi3:mini must handle all routine tasks locally
